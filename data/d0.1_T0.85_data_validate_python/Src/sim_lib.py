...
class sim_lib:
    ...
    def get_rdf(self, process_no_begin, process_no_end, file_start, file_end, molecule_type1, molecule_type2, particle_id1, particle_id2, nhis):
        rdf_generator = radial_distribution_function()
        rdf_generator.calculate(process_no_begin, process_no_end, file_start, file_end, molecule_type1, molecule_type2, particle_id1, particle_id2, nhis)
    ...
    def generate_specific_rdf(self, process_no_begin, process_no_end, file_start, file_end, molecule_in_cluster, molecule_outside_cluster, particle_id1, particle_id2, r_cut, rho, nhis, box = 10):
        ...
        specific_rdf_generator.get_secific_rdf(process_no_begin, process_no_end, file_start, file_end, molecule_in_cluster, molecule_outside_cluster, particle_id1, particle_id2, r_cut, rho,nhis, box)
